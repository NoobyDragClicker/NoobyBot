...
public class Evaluation
{
    ...
    public int[] passedPawnBonuses = { 0, 15, 25, 40, 60, 100, 100, 0 };
    public int[] isolatedPawnPenalty = { 0, -15, -30, -50, -75, -75, -75, -75, -75 };
